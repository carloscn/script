...
CROSS_AARCH32_ADDR="https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu/13.2.rel1/binrel/arm-gnu-toolchain-13.2.rel1-x86_64-arm-none-linux-gnueabihf.tar.xz"
CROSS_AARCH64_ADDR="https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu/13.2.rel1/binrel/arm-gnu-toolchain-13.2.rel1-x86_64-aarch64-none-linux-gnu.tar.xz"
CROSS_GNUEABI_ADDR="https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu/13.2.rel1/binrel/arm-gnu-toolchain-13.2.rel1-x86_64-arm-none-eabi.tar.xz"
...
utils_wget_download ${CROSS_GNUEABI_ADDR} || utils_check_ret $? "wget the GNUEABI cross compiler toolchains"
...
FILE=$(basename "$CROSS_GNUEABI_ADDR")
sudo tar -xvf ${FILE} -C ${DEST_DIR} || utils_check_ret $? "install gnu eabi"